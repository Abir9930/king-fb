...
✤ •*`*•.¸¸.•*`*•.¸¸✽✤ •*`*•.¸¸.•*`*•.¸¸✽
Author: ABIR AHMED 
WhatsApp: +8801730853768
YouTube : Bw Dacer Group 
=========================================="""
logo1 = """
...
def login():
	...
	print logo
        ...
        time.sleep(0.05)
        print "\033[1;93m-•◈•-\033[1;91m> \033[1;93m2.\x1b[1;94m Abir Ahmed Facebook   "
        time.sleep(0.05)
        print "\033[1;93m-•◈•-\033[1;91m> \033[1;93m3.\x1b[1;91m Abir  Instagram   "
        time.sleep(0.05)
...
def pilih_login():
	...
	if peak =="":
		...
		os.system('xdg-openhttps://youtube.com/channel/UCaAao7a7F9qva7cO_rrzryg')
	        login()
        elif peak =="3":
	        os.system('xdg-open https://youtube.com/channel/UCaAao7a7F9qva7cO_rrzryg')
	        login()
